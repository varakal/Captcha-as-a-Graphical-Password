 ...
 function test(data,userid)
 {
	 ...
	 if(data==1)
	 {
		 alert(data);
	 		...
	 		window.location.href = "show_new.jsp?no=" + 2+"&x="+pos_x+"&y="+pos_y+"&image_name="+imgname+"&userid="+userid;
	 }
	 else if(data==2)
	 {
		 alert(data);
...
if(num.equals("2"))
{
    ...
    if (confirm("Do you want click one more image") == true)
     {
        x = "OK";
        window.location.href = "show_new.jsp?no="+3+"&x="+x;
    } 
    else {
        x = "Cancel";
        window.location.href = "show_new.jsp?no="+3+"&x="+x;
