 ...
 function test(data,userid)
 {
	 ...
	 if(data==1)
	 {
			...
			alert(userid);
	 		...
	 		window.location.href = "show.jsp?no=" + 2+"&x="+pos_x+"&y="+pos_y+"&image_name="+imgname+"&userid="+userid;
	 }
	 else if(data==2)
	 {
...
<form name="form1">
<div><p>Captcha Graphical Password Settings</p></div>
...
<img alt="" id="img2" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(1)%>" style="position: absolute;left: 50px;" onclick="test('2','<%=userid%>')">
<img alt="" id="img3" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(2)%>" style="position: absolute;left: 100px;" onclick="test('3','<%=userid%>')">

<img alt=""  id="img4" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(3)%>" style="position: absolute;top: 50px;left:0px;" onclick="test('4','<%=userid%>')" >
<img alt="" id="img5" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(4)%>" style="position: absolute;top: 50px;left: 50px;" onclick="test('5','<%=userid%>')">
<img alt=""  id="img6" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(5)%>" style="position: absolute;top: 50px;left: 100px;" onclick="test('6','<%=userid%>')">

<img alt="" id="img7" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(6)%>" style="position: absolute;top: 100px;left: 0px;" onclick="test('7','<%=userid%>')">
<img alt="" id="img8" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(7)%>" style="position: absolute;top: 100px;left: 50px;" onclick="test('8','<%=userid%>')">
<img alt="" id="img9" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(8)%>" style="position: absolute;top: 100px;left: 100px;"  onclick="test('9','<%=userid%>')">
...
if(num.equals("2"))
{
	...
	int xval=Integer.parseInt(x)/10;
	int yval=Integer.parseInt(y)/10;
    ...
    var x;
    if (confirm("Do you want click one more image") == true)
     {
        x = "OK";
        window.location.href = "show.jsp?no="+3+"&x="+x;
    } 
    else {
        x = "Cancel";
        window.location.href = "show.jsp?no="+3+"&x="+x;
...
<img alt="" id="img2" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(1)%>" style="position: absolute;left: 50px;" onclick="test('2','<%=user%>')">
<img alt="" id="img3" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(2)%>" style="position: absolute;left: 100px;" onclick="test('3','<%=user%>')">

<img alt=""  id="img4" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(3)%>" style="position: absolute;top: 50px;left:0px;" onclick="test('4','<%=user%>')" >
<img alt="" id="img5" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(4)%>" style="position: absolute;top: 50px;left: 50px;" onclick="test('5','<%=user%>')">
<img alt=""  id="img6" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(5)%>" style="position: absolute;top: 50px;left: 100px;" onclick="test('6','<%=user%>')">

<img alt="" id="img7" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(6)%>" style="position: absolute;top: 100px;left: 0px;" onclick="test('7','<%=user%>')">
<img alt="" id="img8" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(7)%>" style="position: absolute;top: 100px;left: 50px;" onclick="test('8','<%=user%>')">
<img alt="" id="img9" src="<%=request.getContextPath()%>/Res/SourceImage/<%=list.get(8)%>" style="position: absolute;top: 100px;left: 100px;"  onclick="test('9','<%=user%>')">
...
System.out.println("+++++++++++= No =+++++++++++++++");
		...
		<jsp:forward page="/PasswordCheck"></jsp:forward>
